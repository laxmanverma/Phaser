...
```html
<script src="//cdn.jsdelivr.net/npm/phaser-ce@2.13.2/build/phaser.js"></script>
```
...
[Custom builds](https://cdn.jsdelivr.net/npm/phaser-ce@2.13.2/build/custom/) are available too.
